...
<html lang="ko">
    <head>
        ...
        <link href="lightstyles.css" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-light bg-light">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="layout-light.php">Go Game Chart</a>
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="layout-light.php"><i class="fas fa-bars"></i></button>
            <!-- Navbar Search-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="layout-light.php">
                            ...
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        STEAM GAME CCU(Concurrent Users) Ranking
                                    </div>
                                    <?php
                                        $host = 'localhost';
                                        $user = 'tjdckdwh0';
